# helper functiona - helper.py file
...
objects_path = r'\path_outputs'

# pyspark objects
char_labels = PipelineModel.load(objects_path + '/char_label_model.h5') 
assembleModel = PipelineModel.load(objects_path + '/assembleModel.h5')
clf_model = RandomForestClassificationModel.load(objects_path + '/clf_model.h5')


#python objects
with open(objects_path + '/file.pkl', 'rb') as handle:
